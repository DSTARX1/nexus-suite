...
const TOOL_SCOPE: Record<string, Set<string>> = {
  ...
  "tiktok-main":            new Set(["delegateToSubAgent", "fetchTikTokComments", "scheduleTikTokPost", "getTikTokPostStatus"]),
  "instagram-main":         new Set(["delegateToSubAgent", "fetchIGComments", "replyToIGComment", "scheduleInstagramPost", "getInstagramPostStatus"]),
  "x-main":                 new Set(["delegateToSubAgent", "scheduleXPost", "postXThread"]),
